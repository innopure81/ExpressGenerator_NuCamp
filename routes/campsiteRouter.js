...
.get((req, res, next)=>{
    Campsite.find()
    .populate('comments.author') //<== Mongoose Population: req.body.author = req.user._id; campsite.comments.push(req.body);
    .then(campsites=>{
        res.statusCode = 200;
...
.get((req, res, next)=>{
    ...
    .populate('comments.author') //<== req.body.author = req.user._id; campsite.comments.push(req.body);
    .then(campsite =>{
        res.statusCode = 200;
        res.setHeader('Content-Type', 'application/json');
        res.json(campsite);
